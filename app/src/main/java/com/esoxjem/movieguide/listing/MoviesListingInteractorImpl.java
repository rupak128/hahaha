...
class MoviesListingInteractorImpl implements MoviesListingInteractor {
    ...
    public static String searchQuery="Inception";
    ...
    @Override
    public Observable<List<Movie>> fetchMovies(String movieName) {
        ...
        if(movieName=="NULL"){
            ...
            return tmdbWebService.search(movieName).map(MoviesWraper::getMovieList);
