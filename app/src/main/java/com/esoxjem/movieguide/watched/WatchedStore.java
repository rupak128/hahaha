 ...
 */
@Singleton
public class WatchedStore
{

    private static final String PREF_NAME = "WatchedStore";
    private SharedPreferences pref;

    @Inject
    public WatchedStore(Context context)
    {
    ...
    public List<Movie> getWatched() throws IOException
    {
